...
- Déploiement automatique vers staging (branche develop)
- Déploiement automatique vers production (branche main)
- Création automatique des releases
- Notifications Slack pour suivre les déploiements
